...
public class Team {
    ...
    public Team(String cup, String date, String time, String result, String team1, String team1Info, String team2, String team2Info, String video, String videoLink, String report, String reportLink) {
        this.cup = cup;
        this.date = date;
        this.time = time;
        this.result = result;
