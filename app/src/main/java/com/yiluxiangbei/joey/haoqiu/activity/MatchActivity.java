...
public class MatchActivity extends AppCompatActivity {
    ...
    public int unStartedColor = 0xff009688;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (status.equals("已结束")){
            tvStatus.setBackgroundColor(endedColor);
        }else if (status.equals("进行中")){
            tvStatus.setBackgroundColor(competingColor);
        }else {
            tvStatus.setBackgroundColor(unStartedColor);
        }
    ...
    private void setListeners(){
        tvTeam1.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(MatchActivity.this,LoadWebActivity.class);
